...
if("TRUE" STREQUAL "TRUE")
  set(mybot_control_SOURCE_PREFIX /home/longxig/AuE893_S17_GUO/src/mybot_ws/src/mybot_control)
  set(mybot_control_DEVEL_PREFIX /home/longxig/AuE893_S17_GUO/devel)
  ...
  set(mybot_control_INSTALL_PREFIX /home/longxig/AuE893_S17_GUO/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'mybot_control' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/longxig/AuE893_S17_GUO/src/mybot_ws/src/mybot_control/${idir}'.  Ask the maintainer 'robocpu <robocpu@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${mybot_control_dep}_FOUND)
      find_package(${mybot_control_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${mybot_control_dep} REQUIRED ${depend_list})
  endif()
