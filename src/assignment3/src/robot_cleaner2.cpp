...
geometry_msgs::PoseWithCovarianceStamped gazebo_pos;
...
int main(int argc, char **argv)
{
	...
	pose_subscriber = n.subscribe("/robot_pose_ekf/odom_combined", 50, poseCallback);
	ROS_INFO("\n\n\n******PREPARE TESTING************\n");
	ros::Rate idle(0.2);
	idle.sleep();
	ROS_INFO("\n\n\n**********STAR NOW***************\n");
...
double quad2rad(geometry_msgs::PoseWithCovarianceStamped msg){
